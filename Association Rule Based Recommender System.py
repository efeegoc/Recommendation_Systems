...
# armut_data.csv dosyası okutalım.
dosya_yolu = r'C:\Users\ExtraBT\Desktop\MASAUSTU\Yazılım\Python\Recommendation Systems\armut_data.csv'
df_ = pd.read_csv(dosya_yolu)
df = df_.copy()
df.head()
...
#########################
# Birliktelik Kuralları Üretelim
#########################

# Aşağıdaki gibi sepet hizmet pivot table’i oluşturalım.
...
# arl_recommender fonksiyonunu kullanarak en son 2_0 hizmetini alan bir kullanıcıya hizmet önerisinde bulalım.
